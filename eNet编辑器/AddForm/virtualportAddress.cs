...
{
    public partial class virtualportAddress : Form
    {
        public virtualportAddress()
        {
            InitializeComponent();
        }
        ...
        private void virtualportAddress_Load(object sender, EventArgs e)
        {
            for(int i =1;i<100;i++)
            {
                cb4.Items.Add(i);
        ...
        private void virtualportAddress_Paint(object sender, PaintEventArgs e)
        {
