...
{
    public partial class panelAdd : Form
    {
        public panelAdd()
        {
            InitializeComponent();
        ...
        public event Action addPanelNode;
        ...
        private void panelAdd_Load(object sender, EventArgs e)
        {
            txtGateway.Text = Ip;
            txtNum.Text = num;
            cbs1.Items.Clear();
