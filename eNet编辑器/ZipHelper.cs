...
namespace eNet编辑器
{
    class ZipHelper
    {
        ...
        public void ZipFile(string filePath, string zipedFileName, int compressionLevel = 6)
        {
            // 如果文件没有找到，则报错 
        ...
        /// <returns></returns>
        public bool ZipManyFilesOrDictorys(IEnumerable<string> folderOrFileList, string zipedFile)
        {
            bool res = true;
