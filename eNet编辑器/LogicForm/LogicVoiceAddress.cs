...
{
    public partial class LogicVoiceAddress : Form
    {
        public LogicVoiceAddress()
        {
            InitializeComponent();
        }
        ...
        //bool isLoad = false;
        private void LogicVoiceAddress_Load(object sender, EventArgs e)
        {
            try
            {
                cbTypeitemIni();
        ...
        {   
            ...
            string tmp = "";
            tmp = IniConfig.GetValue(Application.StartupPath + "//types//9.0_virtualport.ini", "address", "2");
        ...
        /// </summary>
        private void iniInfo(string iniType)
        {
            ...
            else
            {
                ...
                string path = string.Format("{0}//types//9.0_virtualport.ini", Application.StartupPath);
        ...
        private void LogicVoiceAddress_Paint(object sender, PaintEventArgs e)
        {
